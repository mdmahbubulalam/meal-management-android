        ...
        />
          ...
          :
            ...
            <ScrollView>
              ...
              <Text style={{color:"white", fontSize:16, textAlign:'center' , fontWeight:'bold', marginBottom:5}}>Your Total Expense = {totalExpense}</Text>

              <Text style={{color:"white", fontSize:16, textAlign:'center' , fontWeight:'bold', marginBottom:5}}>Your Total Meal = {totalMealCount}</Text>
